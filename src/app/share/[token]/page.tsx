...
import type { SharePackage, ExternalSnapshot } from '@/lib/shares/types';
import {
  Building2,
  TrendingUp,
  TrendingDown,
...
export default function ExternalSharePage() {
  ...
  const { executiveSummary, kpiHighlights, governance, roadmap } = snapshot;
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            ...
            <div className="mb-6">
              ...
              <div className="space-y-2">
                {governance.wbrRecords.map((wbr, i) => (
                  <div
                    key={i}
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {roadmap.nextMonth.map((item, i) => (
                    <div
                      key={i}
                      className="p-2 bg-orange-50 rounded border border-orange-100 text-sm"
                    >
                      {item.name}
                    </div>
                  ))}
              ...
              <div>
                ...
                <div className="space-y-2">
                  {roadmap.thisQuarter.map((item, i) => (
                    <div
                      key={i}
