// /api/applications/[id]/reject - 申請却下API
// submitted → rejected への状態遷移
...
export async function POST(
  ...
  try {
    ...
    console.error('Application reject API error:', error);
    return NextResponse.json(
      {
        success: false,
