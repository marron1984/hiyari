  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6 safe-bottom">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl font-bold text-zinc-900">経費・残業</h1>
          {lastUpdated && (
      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        ...
        >
          ...
          <p className="text-xs text-zinc-500">進行中</p>
        </Card>
        ...
        <div className="mb-4 p-3 bg-orange-50 border border-orange-200 rounded-xl flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-medium text-orange-700">
              {returnedCount}件が差戻されています
            </p>
            <p className="text-xs text-orange-600">修正して再提出してください</p>
          </div>
        </div>
      )}
